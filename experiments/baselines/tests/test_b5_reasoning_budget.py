...
@pytest.mark.parametrize("method,exhausted", [("b5_gepa",True),("b5_gepa",False),("b0_dynamic",True),("b0_dynamic",False),("b1_static_skill",True),("b1_static_skill",False),("b3_skillopt",False)])
def test_actual_skillopt_backend_budget_and_frozen_b3(tmp_path,monkeypatch,method,exhausted):
    ...
    try:
        ...
        if method in {"b5_gepa", "b0_dynamic", "b1_static_skill"}:
